...
const buttonTags = [`All`, `Korean`, `Japanese`, `Chinese`];
...
const btnAll = document
  .querySelector('#All')
  .addEventListener('click', getAllFoods);
const btnKorean = document
  .querySelector('#Korean')
  .addEventListener('click', getKoreanFoods);
const btnJapanese = document
  .querySelector('#Japanese')
  .addEventListener('click', getJapaneseFoods);
const btnChinese = document
  .querySelector('#Chinese')
  .addEventListener('click', getChineseFoods);
